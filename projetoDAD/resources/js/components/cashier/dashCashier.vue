  ...
  <v-app id="inspire">
    <v-navigation-drawer v-model="drawer" fixed clipped app>
      <v-list class="pa-3" dense>
        ...
        <router-link tag="span" style="cursor: pointer" to="/privatedashboard/cashier">
          <v-list-tile>
            <v-list-tile-action>
              <v-icon color="white white-1">settings</v-icon>
            </v-list-tile-action>
        ...
        <router-link tag="span" style="cursor: pointer" to="/items">
          <v-list-tile>
            ...
            >Items Management</v-list-tile-title>
          </v-list-tile>
        </router-link>
    ...
    <v-toolbar color="blue" dense fixed clipped-left app>
      ...
      <v-toolbar-title class="mr-5 align-center">
        <span class="title">Cashier Manager</span>
      </v-toolbar-title>
      <v-spacer></v-spacer>
    </v-toolbar>
    <v-content>

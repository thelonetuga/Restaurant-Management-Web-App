            ...
            <v-layout row wrap>
                ...
                <v-flex xs12 sm6 offset-sm3 mt-3>
                    <v-flex class="text-xs-center" mt-5>
                        <v-btn v-on:click.prevent="showeditPassword = true" color="primary" type="submit">Edit Password</v-btn>
                    </v-flex>
                    <form>
					...
					disabled
                        ...
                        <v-flex class="text-xs-center" mt-5>
                            <v-btn v-on:click.prevent="saveUser()" color="primary" type="submit">Save Profile
                            </v-btn>
                        </v-flex>
                    </form>
                </v-flex>
                ...
                <v-layout row justify-center>
                    <v-dialog v-model="showeditPassword" persistent max-width="600px">
                        <edit_password @closeDialog="closedialog"></edit_password>
                    </v-dialog>
                </v-layout>
            </v-layout>
        </v-container>

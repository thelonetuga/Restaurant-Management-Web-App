            ...
            <v-list class="pa-3" dense>
                ...
                <router-link tag="span" style="cursor: pointer" to="/privatedashboard/manager">
                    <v-list-tile>
                        ...
                        <v-list-tile-title @click="showMainView" class="white--text text--white-1">My Dashboard
                        </v-list-tile-title>
                    </v-list-tile>
                </router-link>
                ...
                <router-link tag="span" style="cursor: pointer" to="/privatedashboard/manager/statistics">
                    <v-list-tile>
                        <v-list-tile-action>
                            <v-icon color="white white-1">format_list_bulleted</v-icon>
                        </v-list-tile-action>
                        ...
                        <v-container grid-list-md>
                            <v-layout align-center justify-start row fill-height>
                                <v-flex xs12 sm6 offset-sm0>
                                    <list_blocked_users @user-unblocked="userUnblock"
                                                        :blockuser="trigger"></list_blocked_users>
                                </v-flex>
                                <v-flex xs12 sm6 offset-sm0>
                                    <list_unblocked_users @user-blocked="userBlock"
                                                          :unblockUser="trigger"></list_unblocked_users>
                                </v-flex>
                            </v-layout>
                        </v-container>
                        <br>
                        <summary_meals :updateOrderTable="updateOrderTable"
                                       :updateMealTable="updateMealTable"></summary_meals>
                        <br>
                    </v-flex>
                    <v-flex v-else>
